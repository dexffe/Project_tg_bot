...
keyboard0.add('/info')
s1 = ['/usd', '/eur', '/cny', '/turn', '/inversion', '/bl_wht', '/game_news', '/russian_news', '/weather', '/Russian',
      '/English', '/French', '/translation', '/num_sys', '/cash', '/generator', '/interpreter', '/news', '/image',
      '/money', '/number', '/login_password', '/info']
...
def send_welcome(message):
    ...
    if os.path.isfile("translate_cash.txt"):
